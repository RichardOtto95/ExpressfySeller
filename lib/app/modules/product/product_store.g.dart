...
mixin _$ProductStore on _ProductStoreBase, Store {
  ...
  final _$getAverageRatingAsyncAction =
      AsyncAction('_ProductStoreBase.getAverageRating');

  @override
  Future<Map<String, dynamic>> getAverageRating(String adsId) {
    return _$getAverageRatingAsyncAction
        .run(() => super.getAverageRating(adsId));
  }
